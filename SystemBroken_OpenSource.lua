...
if game.CoreGui:FindFirstChild("SysBroker") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "System Broken Modded",Text = "GUI Already loaded, rejoin to re-execute",Duration = 10;})
	return
end
local version = 2
--VARIABLES
...
local AdidasSports_Button = Instance.new("TextButton")
--NEWS
...
AdidasSports_Button.Name = "AdidasSports_Button"
AdidasSports_Button.Parent = Animations_Section
AdidasSports_Button.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
AdidasSports_Button.BackgroundTransparency = 0.500
AdidasSports_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
AdidasSports_Button.BorderSizePixel = 0
AdidasSports_Button.Position = UDim2.new(0, 25, 0, 525)
AdidasSports_Button.Size = UDim2.new(0, 150, 0, 30)
AdidasSports_Button.Font = Enum.Font.Oswald
AdidasSports_Button.Text = "adidas Sports"
AdidasSports_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
AdidasSports_Button.TextScaled = true
AdidasSports_Button.TextSize = 14.000
AdidasSports_Button.TextWrapped = true
...
CreateClicker(AdidasSports_Button) 
...
CMDBar.FocusLost:Connect(function()
	...
	SendNotify("System Broken 2.0",("Executed "..command),5)
	CMDBar.Text = ""
end)
...
AdidasSportsAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
	...
	while task.wait(10) do
		pcall(function()
			...
			if version<GuiVersion then
				SendNotify("System Broken 2.0","You are not using the latest version, please run the script again.",5)
				task.wait(5)
				SysBroker:Destroy()
				game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
			end
	...
	while task.wait(60) do
		pcall(function()
			...
			if (plr.Name ~= original_name) or (plr.DisplayName ~= original_display) or (plr.UserId ~= plr.CharacterAppearanceId) then
				SysBroker:Destroy()
				SendNotify("System Broken 2.0","An unexpected error occurred, re-joining...")
				game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
			end
...
SendNotify("System Broken 2.0","ALPHA-0.1",10)
setclipboard("THIS IS ALPHA. CREDITS TO SYSTEM CALIX")